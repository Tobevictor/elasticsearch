 ...
 */
public class VIEW_MAP_CK_BJINFO implements Serializable {
    //BJNO
    private String bino;
    //BSNUM
    ...
    public String get总储量() {
        return 总储量;
    }

    public void set总储量(String 总储量) {
        this.总储量 = 总储量;
    }

    public String get储量单位() {
        return 储量单位;
    }

    public void set储量单位(String 储量单位) {
        this.储量单位 = 储量单位;
    }
}

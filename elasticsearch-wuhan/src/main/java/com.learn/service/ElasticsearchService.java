...
public interface ElasticsearchService {
	...
	ServiceResult fulltextQuery(String index, String queryType, FullTextCondition condition, PageInfo pageInfo);

	ServiceResult termsQuery(String index, String queryType, TermsLevelCondition condition,PageInfo pageInfo);

	ServiceResult geoQuery(String index, String queryType, GeoCondition condition,PageInfo pageInfo);

	ServiceResult boolQuery(String index, BoolCondition conditions, PageInfo pageInfo);
}
